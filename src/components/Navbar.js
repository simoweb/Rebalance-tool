      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex space-x-8 items-center">
            <a href="#perche" onClick={(e) => handleScroll(e, 'perche')} className="text-base text-gray-600 hover:text-indigo-600 transition-colors duration-200">
              Perché Ribilanciare
            </a>
            <a href="#quando" onClick={(e) => handleScroll(e, 'quando')} className="text-base text-gray-600 hover:text-indigo-600 transition-colors duration-200">
              Quando Ribilanciare
            </a>
            <a 
              href="#calcolatore" 
              onClick={(e) => handleScroll(e, 'calcolatore')}
        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-48 opacity-100' : 'max-h-0 opacity-0'} overflow-hidden`}>
          <div className="py-2 space-y-1">
            <a 
              href="#perche" 
              onClick={(e) => handleScroll(e, 'perche')}
            ...
            <a 
              href="#quando" 
              onClick={(e) => handleScroll(e, 'quando')}
              className="block px-4 py-2 text-base text-gray-600 hover:bg-gray-50 hover:text-indigo-600 transition-colors duration-200"
            >
              Quando Ribilanciare
            </a>
